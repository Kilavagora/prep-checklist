...
cp[3] = document.getElementById("cp4");
cp[4] = document.getElementById("cp5");
cp[5]  = document.getElementById("cp6");
cp[6]  = document.getElementById("cp7");
cp[7] = document.getElementById("cp8");
cp[8] = document.getElementById("cp9");
cp[9] = document.getElementById("cp10");
cp[10] = document.getElementById("cp11");
cp[11] = document.getElementById("cp12");
cp[12] = document.getElementById("cp13");
cp[13] = document.getElementById("cp14");
cp[14] = document.getElementById("cp15");
cp[15] = document.getElementById("cp16");
cp[16] = document.getElementById("cp17");
cp[17] = document.getElementById("cp18");
cp[18] = document.getElementById("cp19");

ct[0] = document.getElementById("color1");
ct[1] = document.getElementById("color2");
ct[2] = document.getElementById("color3");
ct[3] = document.getElementById("color4");
ct[4] = document.getElementById("color5");
ct[5]  = document.getElementById("color6");
ct[6]  = document.getElementById("color7");
ct[7] = document.getElementById("color8");
ct[8] = document.getElementById("color9");
ct[9] = document.getElementById("color10");
ct[10] = document.getElementById("color11");
ct[11] = document.getElementById("color12");
ct[12] = document.getElementById("color13");
ct[13] = document.getElementById("color14");
ct[14] = document.getElementById("color15");
ct[15] = document.getElementById("color16");
ct[16] = document.getElementById("color17");
ct[17] = document.getElementById("color18");
ct[18] = document.getElementById("color19");

color[0] = document.getElementById("color1").value;
color[1] = document.getElementById("color2").value;
color[2] = document.getElementById("color3").value;
color[3] = document.getElementById("color4").value;
color[4] = document.getElementById("color5").value;
color[5] = document.getElementById("color6").value;
color[6] = document.getElementById("color7").value;
color[7] = document.getElementById("color8").value;
color[8] = document.getElementById("color9").value;
color[9] = document.getElementById("color10").value;
color[10] = document.getElementById("color11").value;
color[11] = document.getElementById("color12").value;
color[12] = document.getElementById("color13").value;
color[13] = document.getElementById("color14").value;
color[14] = document.getElementById("color15").value;
color[15] = document.getElementById("color16").value;
color[16] = document.getElementById("color17").value;
color[17] = document.getElementById("color18").value;
color[18] = document.getElementById("color19").value;
...
window.addEventListener("load", colorPalette, false);
...
function colorPicker(i) {
            ...
            //console.log (cp[i]);
            //console.log (color[i]);
            cp[i].addEventListener("input", (updateColor(i)), false);
            cp[i].addEventListener("change", (updateColor(i)), false);
            //ct[i].select();
}
...
function updateColor(i) {
            ...
            console.log (cp[i]);
            console.log (color[i]);
            //$("#interface4").css("background-color", cp[n].value);
            //$('#examples table.table tr:nth-child(1)').css("background-color", color[n]);
            //$('#examples table.table tr:nth-child(3)').css("background-color", color[n]);
            //exportCPcolor();
            //color[n] = color[n];
            //cp[i] = color[i];
            //ct[n] = color[n];
