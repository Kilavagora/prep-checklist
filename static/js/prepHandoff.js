...
function saveClient(clientData) {
	...
	oReq.onload = function() {
		...
		alert('Your record has been saved. The form will be cleared.')
		$('form')[0].reset();
	}
...
function saveClientPDF() {
            ...
            //Load client fonts
			doc.addFont("Advent Pro","Advent Pro","");
            ...
            doc.setFontSize(8);
			doc.setFont("Advent Pro");
            doc.text("Font 1:" + String(clientFonts[0].name), 3, 1.2);
