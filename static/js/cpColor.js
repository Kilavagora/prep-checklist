...
function saveColorPDF() {
            ...
            if($("#clientName").val() == "") {
                        $("#clientName").val(prompt("Please enter the client in this format: ST-City"));	
            }
            ...
            $.each(colorList[0], function(key, value)  {
                        if (key == 'color14') {doc.text("Headline " + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color15') {doc.text("Subhead 1 " +  ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color16') {doc.text("Subhead 2 " + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color17') {doc.text("Content Text " + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color18') {doc.text("Hyperlink " + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color19') {doc.text("Subtext " + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color1') {doc.text("Color 1" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color2') {doc.text("Color 2" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color3') {doc.text("Color 3" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color4') {doc.text("Color 4" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color5') {doc.text("Color 5" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color6') {doc.text("Color 6" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color7') {doc.text("Color 7" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color8') {doc.text("Color 8" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color9') {doc.text("Color 9" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color10') {doc.text("Color 10" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color11') {doc.text("Color 11" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color12') {doc.text("Color 12" + ": " + value,4.8, (posOffset-.5));}
                        else if (key == 'color13') {doc.text("Color 12" + ": " + value,4.8, (posOffset-.5));}
                        ...
                        if (value.charAt(0) == "#") {
                                    ...
                                    doc.rect(3.95, (posOffset-.75), .75, .4, 'FD');
                                    posOffset += .5;
...
function loadTota11y() {
            $('body').append("<script src='js/tota11y.min.js'></script>")
}

function hideTota11y() {
